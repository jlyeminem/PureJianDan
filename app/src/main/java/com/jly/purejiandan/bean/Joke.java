 ...
 * comment_author : 同志们好
 * comment_author_email : 284088912@qq.com
 * comment_author_url :
 * comment_author_IP : 113.77.2.64
 * comment_date : 2016-06-08 13:04:27
 * comment_date_gmt : 2016-06-08 05:04:27
 * comment_content : 在电影院看《魔兽》时喊一声德玛西亚必胜，为什么会被砍？？没玩过这游戏。部落和联盟有什么恩怨？
 * comment_karma : 0
 * comment_approved : 1
 * comment_agent : Mozilla/5.0 (iPhone; CPU iPhone OS 9_3_2 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Mobile/13F69 MicroMessenger/6.3.16 NetType/WIFI Language/zh_CN
 * comment_type :
 * comment_parent : 0
 * user_id : 0
 * comment_subscribe : N
 ...
 * vote_negative : 3
 * vote_ip_pool :
 * text_content : 在电影院看《魔兽》时喊一声德玛西亚必胜，为什么会被砍？？没玩过这游戏。部落和联盟有什么恩怨？
 * videos : []
 */
