...
/**
 *
 * Created by jly on 16/3/30.
 */
public class PrefUtil {

    private static final String PRE_NAME = "com.jly.purejiandan_preferences";
    private static final String PRE_NIGHT = "night";

    private static SharedPreferences getSharedPreferences() {
        return App.getContext().getSharedPreferences(PRE_NAME,Context.MODE_PRIVATE);
    }
